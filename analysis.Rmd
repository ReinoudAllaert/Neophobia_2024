...
# Given the correlation of 1 and the fact that we still get a singular fit, try to reduce the model, in addition, the interaction between sex and object is nongisn, lets drop it.
...
emms_interaction_zoi <- emmeans(zoi_model_log, 
                               specs = c("Object_contrast", "Context_contrast"), 
                               at = list(Object_contrast = c(-0.5, 0.5), 
                                         Context_contrast = c(-0.5, 0.5)),
                               type = "response",
                               tran = make.tran("log")) 

print(emms_interaction_zoi)
summary(emms_interaction_zoi)
...
emms_interactionsex <- emmeans(zoi_model_log, 
                               ...
                               type = "response",
                               tran = make.tran("log"))  # Explicitly define log transformation

print(emms_interactionsex)
summary(emms_interactionsex)
