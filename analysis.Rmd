...
# 13 birds were LBBG instead of HG, in the RR we stated that we would remove those from the analysis:
...
latency_model3_boxcox_reduced seems to be the best fit, but gives warnings (contrary to reduced_2): boundary (singular) fit: see help('isSingular') Warning: Model failed to converge with 1 negative eigenvalue: -4.1e+00
The other model only gives the boundary (singular) fit warning.
